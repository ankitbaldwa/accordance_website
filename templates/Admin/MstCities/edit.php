...
<div class="form-group row">
    ...
    <div class="col-lg-9 col-md-9 col-sm-12">
        <?= $this->Form->control('mst_state_id', ['type'=> 'select','label'=>false, 'options' => $mstStates, 'class' => 'form-control', 'placeholder'=>'Select State', 'empty'=>'Select State', 'required'=> false]) ?>
    </div>
</div>
<div class="form-group row">
