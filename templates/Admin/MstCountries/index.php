                            ...
                            <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    <div class="kt-portlet__head-actions">
                                        <div class="dropdown dropdown-inline">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="kt-nav">
                                                    ...
                                                    <li class="kt-nav__item">
                                                        <?= $this->Html->link('<i class="kt-nav__link-icon la la-file-excel-o"></i><span class="kt-nav__link-text">Excel</span>', ['prefix'=>'Admin','controller' => 'MstCountries','action' => 'download_excel','excel'], ['class' => 'kt-nav__link', 'escape' => false, 'title'=>'Export Countries In Excel']) ?>
                                                    </li>
                                                    <li class="kt-nav__item">
                                                        <?= $this->Html->link('<i class="kt-nav__link-icon la la-file-text-o"></i><span class="kt-nav__link-text">CSV</span>', ['prefix'=>'Admin','controller' => 'MstCountries','action' => 'download_excel','csv'], ['class' => 'kt-nav__link', 'escape' => false, 'title'=>'Export Countries In CSV']) ?>
                                                    </li>
                                                    <!--<li class="kt-nav__item">
                                        ...
                                        &nbsp;
                                        <?= $this->Html->link('<i class="la la-plus"></i> New Country', 'javascript:void(0)', ['class' => 'btn btn-brand btn-elevate btn-icon-sm add', 'escape' => false, 'data-url'=>$this->Url->build(['prefix'=>'Admin','controller' => 'MstCountries','action' => 'add']), 'title'=>'Add Country']) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--end::Modal-->
<script>
    var url = "<?= $this->Url->build(['prefix'=>'Admin', 'controller'=>'MstCountries', 'action'=>'ajax']) ?>";
    var column = [
				{
					targets: -1,
					title: 'Actions',
