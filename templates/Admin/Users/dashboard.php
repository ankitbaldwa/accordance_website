	...
	<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
		...
		<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
			...
			<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
				...
				<?= $this->element('content_head', array('page_name'=>'Dashboard')); ?>
				<!-- begin:: Content -->
										...
										<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
											...
											<div class="kt-timeline-v2__item">
												...
												<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
													<a href="#"><img src="<?= $this->Url->assetUrl('/assets/media/users/100_4.jpg') ?>" title=""></a>
													<a href="#"><img src="<?= $this->Url->assetUrl('/assets/media/users/100_13.jpg') ?>" title=""></a>
													<a href="#"><img src="<?= $this->Url->assetUrl('/assets/media/users/100_11.jpg') ?>" title=""></a>
													<a href="#"><img src="<?= $this->Url->assetUrl('/assets/media/users/100_14.jpg') ?>" title=""></a>
												</div>
											</div>
											<div class="kt-timeline-v2__item">
						...
						<div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">
							...
							<div class="kt-portlet kt-portlet--height-fluid kt-widget19">
								<div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
									<div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(<?= $this->Url->assetUrl('/assets/media//products/product4.jpg') ?>)">
									...
									<div class="kt-widget19__wrapper">
										<div class="kt-widget19__content">
											<div class="kt-widget19__userpic">
												<img src="<?= $this->Url->assetUrl('/assets/media/users/user1.jpg') ?>" alt="">
											</div>
										...
										<div class="tab-pane active" id="kt_widget5_tab1_content" aria-expanded="true">
											<div class="kt-widget5">
												<div class="kt-widget5__item">
													<div class="kt-widget5__content">
														<div class="kt-widget5__pic">
															<img class="kt-widget7__img" src="<?= $this->Url->assetUrl('/assets/media/products/product27.jpg') ?>" alt="">
														</div>
												...
												<div class="kt-widget5__item">
													<div class="kt-widget5__content">
														<div class="kt-widget5__pic">
															<img class="kt-widget7__img" src="<?= $this->Url->assetUrl('/assets/media/products/product22.jpg') ?>" alt="">
														</div>
														<div class="kt-widget5__section">
															<a href="#" class="kt-widget5__title">
																Branding Mockup
												...
												<div class="kt-widget5__item">
													<div class="kt-widget5__content">
														<div class="kt-widget5__pic">
															<img class="kt-widget7__img" src="<?= $this->Url->assetUrl('/assets/media/products/product15.jpg') ?>" alt="">
														</div>
														<div class="kt-widget5__section">
															<a href="#" class="kt-widget5__title">
																Awesome Mobile App
										...
										<div class="tab-pane" id="kt_widget5_tab2_content">
											<div class="kt-widget5">
												<div class="kt-widget5__item">
													<div class="kt-widget5__content">
														<div class="kt-widget5__pic">
															<img class="kt-widget7__img" src="<?= $this->Url->assetUrl('/assets/media/products/product10.jpg') ?>" alt="">
														</div>
														<div class="kt-widget5__section">
															<a href="#" class="kt-widget5__title">
																Branding Mockup
												...
												<div class="kt-widget5__item">
													<div class="kt-widget5__content">
														<div class="kt-widget5__pic">
															<img class="kt-widget7__img" src="<?= $this->Url->assetUrl('/assets/media/products/product11.jpg') ?>" alt="">
														</div>
														<div class="kt-widget5__section">
															<a href="#" class="kt-widget5__title">
																Awesome Mobile App
												...
												<div class="kt-widget5__item">
													<div class="kt-widget5__content">
														<div class="kt-widget5__pic">
															<img class="kt-widget7__img" src="<?= $this->Url->assetUrl('/assets/media/products/product6.jpg') ?>" alt="">
														</div>
														<div class="kt-widget5__section">
															<a href="#" class="kt-widget5__title">
																Great Logo Designn
									...
									<div class="tab-content">
											...
											<div class="kt-widget4">
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_4.jpg') ?>" alt="">
													</div>
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_14.jpg') ?>" alt="">
													</div>
													<div class="kt-widget4__info">
														<a href="#" class="kt-widget4__username">
															Milano Esco
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_11.jpg') ?>" alt="">
													</div>
													<div class="kt-widget4__info">
														<a href="#" class="kt-widget4__username">
															Nick Bold
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_1.jpg') ?>" alt="">
													</div>
													<div class="kt-widget4__info">
														<a href="#" class="kt-widget4__username">
															Wiltor Delton
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_5.jpg') ?>" alt="">
													</div>
													<div class="kt-widget4__info">
														<a href="#" class="kt-widget4__username">
															Nick Stone
										...
										<div class="tab-pane" id="kt_widget4_tab2_content">
											<div class="kt-widget4">
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_2.jpg') ?>" alt="">
													</div>
													<div class="kt-widget4__info">
														<a href="#" class="kt-widget4__username">
															Kristika Bold
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_13.jpg') ?>" alt="">
													</div>
													<div class="kt-widget4__info">
														<a href="#" class="kt-widget4__username">
															Ron Silk
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_9.jpg') ?>" alt="">
													</div>
													<div class="kt-widget4__info">
														<a href="#" class="kt-widget4__username">
															Nick Bold
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--pic">
														<img src="<?= $this->Url->assetUrl('/assets/media/users/100_8.jpg') ?>" alt="">
													</div>
													<div class="kt-widget4__info">
														<a href="#" class="kt-widget4__username">
															Nick Bold
								...
								<div class="kt-portlet__body">
									<div class="kt-widget3">
										<div class="kt-widget3__item">
											<div class="kt-widget3__header">
												<div class="kt-widget3__user-img">
													<img class="kt-widget3__img" src="<?= $this->Url->assetUrl('/assets/media/users/user1.jpg') ?>" alt="">
												</div>
										...
										<div class="kt-widget3__item">
											<div class="kt-widget3__header">
												<div class="kt-widget3__user-img">
													<img class="kt-widget3__img" src="<?= $this->Url->assetUrl('/assets/media/users/user4.jpg') ?>" alt="">
												</div>
												<div class="kt-widget3__info">
													<a href="#" class="kt-widget3__username">
														Lebron King James
										...
										<div class="kt-widget3__item">
											<div class="kt-widget3__header">
												<div class="kt-widget3__user-img">
													<img class="kt-widget3__img" src="<?= $this->Url->assetUrl('/assets/media/users/user5.jpg') ?>" alt="">
												</div>
												<div class="kt-widget3__info">
													<a href="#" class="kt-widget3__username">
														Deb Gibson
...
<?= $this->Html->script(['../assets/plugins/custom/fullcalendar/fullcalendar.bundle.js','//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM','../assets/plugins/custom/gmaps/gmaps.js','../assets/js/pages/dashboard.js']) ?>
