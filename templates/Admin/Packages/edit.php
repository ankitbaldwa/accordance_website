...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <?= $this->Form->control('product_id', ['options' => $products, 'class' => 'form-control', 'escape' => false, 'label' => false]) ?>
        </div>
        <div class="form-group">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--brand">
                    <label>
                    <?= $this->Form->checkbox('is_monthly', ['label' => false, 'hiddenField'=>false, 'id'=>"is_monthly", "required"=> false, 'checked'=>$checked]) ?>
                    <span></span>
                    </label>
                </span>
            </div>
        </div>
        <div class="form-group is_monthly" style="<?= (!$checked)?'display:none;':'' ?>">
        ...
        <div class="form-group">
            ...
            <?= $this->Form->control('status', ['class' => 'form-control', 'options' => ['Pending'=>'Pending','Buy Now'=>'Buy Now','Coming Soon'=>'Coming Soon','Enquiry'=>'Enquiry'], 'escape' => false, 'label' => false, "required"=> false]) ?>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-2 col-sm-12">
                    <?= $this->Form->control('discount_per', ['class' => 'form-control', 'type' => 'number', 'autocomplete'=>'off', 'escape' => false, 'label' => false, 'placeholder'=> '%', "required"=> false]) ?>
                </div>
                <div class="col-lg-7 col-md-7 col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-2 col-sm-12">
                    <?= $this->Form->control('tax_per', ['class' => 'form-control', 'placeholder'=>'%', 'autocomplete'=>'off', 'escape' => false, 'label' => false, 'id'=>'tax_par', "required"=> false]) ?>
                </div>
                <div class="col-lg-7 col-md-7 col-sm-12">
