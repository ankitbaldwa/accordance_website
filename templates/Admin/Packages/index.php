                            ...
                            <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    <div class="kt-portlet__head-actions">
                                        ...
                                        &nbsp;
                                        <?= $this->Html->link('<i class="la la-plus"></i> New Packages', 'javascript:void(0)', ['class' => 'btn btn-brand btn-elevate btn-icon-sm add', 'escape' => false, 'data-url'=>$this->Url->build(['prefix'=>'Admin','controller' => 'Packages','action' => 'add']), 'title'=>'Add Packages']) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?= $this->Paginator->sort('No of Days') ?></th>
                                        <th><?= $this->Paginator->sort('Price') ?></th>
                                        <th><?= $this->Paginator->sort('Discount Amt') ?></th>
                                        <th><?= $this->Paginator->sort('Tax Amount') ?></th>
                                        <th><?= $this->Paginator->sort('Net Amount') ?></th>
...
<!--end::Modal-->
<script>
    var url = "<?= $this->Url->build(['prefix'=>'Admin', 'controller'=>'Packages', 'action'=>'ajax']) ?>";
    var column = [
				{
					targets: -1,
					title: 'Actions',
