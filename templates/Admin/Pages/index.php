	...
	<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
		...
		<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
			...
			<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
				...
				<?php echo $this->element('content_head', array('page_name'=>'Manage CMS')); ?>
                                        ...
                                        <div class="dropdown dropdown-inline">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="kt-nav">
                                                    ...
                                                    <li class="kt-nav__item">
                                                        <?= $this->Html->link('<i class="kt-nav__link-icon la la-file-excel-o"></i><span class="kt-nav__link-text">Excel</span>', ['prefix'=>'Admin','controller' => 'Pages','action' => 'download_excel','excel'], ['class' => 'kt-nav__link', 'escape' => false, 'title'=>'Export Pages In Excel']) ?>
                                                    </li>
                                                    <li class="kt-nav__item">
                                                        <?= $this->Html->link('<i class="kt-nav__link-icon la la-file-text-o"></i><span class="kt-nav__link-text">CSV</span>', ['prefix'=>'Admin','controller' => 'Users','action' => 'download_excel','csv'], ['class' => 'kt-nav__link', 'escape' => false, 'title'=>'Export Pages In CSV']) ?>
                                                    </li>
                                                    <!--<li class="kt-nav__item">
...
<!--end::Modal-->
<script>
    var url = "<?= $this->Url->build(['prefix'=>'Admin', 'controller'=>'Pages', 'action'=>'ajax']) ?>";
    var column = [
				{
					targets: -1,
					title: 'Actions',
