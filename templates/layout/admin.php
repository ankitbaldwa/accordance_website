...
<head>
    ...
    <?= $this->Html->css(['../assets/css/pages/login/login-2.css','../assets/css/skins/header/base/light', '../assets/css/skins/header/menu/light', '../assets/css/skins/brand/dark','../assets/css/skins/aside/dark','../assets/plugins/custom/datatables/datatables.bundle.css']) ?>
    <!--end::Layout Skins -->
