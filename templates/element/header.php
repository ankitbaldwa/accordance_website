...
<div class="kt-header__topbar">
	...
	<div class="kt-header__topbar-item dropdown">
		...
		<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
			<form>
				...
				<!--begin: Head -->
				<div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(<?= $this->Url->assetUrl('/assets/media/misc/bg-1.jpg') ?>)">
	...
	<div class="kt-header__topbar-item dropdown">
		...
		<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
			<form>
				...
				<!--begin: Head -->
				<div class="kt-head kt-head--skin-dark" style="background-image: url(<?= $this->Url->assetUrl('/assets/media/misc/bg-1.jpg') ?>)">
					<h3 class="kt-head__title">
						User Quick Actions
	...
	<!--<div class="kt-header__topbar-item kt-header__topbar-item--langs">
		<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
			<span class="kt-header__topbar-icon">
				<img class="" src="<?= $this->Url->assetUrl('/assets/media/flags/226-united-states.svg') ?>" alt="" />
			</span>
		</div>
			...
			<ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
				<li class="kt-nav__item kt-nav__item--active">
					<a href="#" class="kt-nav__link">
						<span class="kt-nav__link-icon"><img src="<?= $this->Url->assetUrl('/assets/media/flags/226-united-states.svg') ?>" alt="" /></span>
						<span class="kt-nav__link-text">English</span>
					</a>
				</li>
				<li class="kt-nav__item">
					<a href="#" class="kt-nav__link">
						<span class="kt-nav__link-icon"><img src="<?= $this->Url->assetUrl('/assets/media/flags/128-spain.svg') ?>" alt="" /></span>
						<span class="kt-nav__link-text">Spanish</span>
					</a>
				</li>
				<li class="kt-nav__item">
					<a href="#" class="kt-nav__link">
						<span class="kt-nav__link-icon"><img src="<?= $this->Url->assetUrl('/assets/media/flags/162-germany.svg') ?>" alt="" /></span>
	...
	<div class="kt-header__topbar-item kt-header__topbar-item--user">
		<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
			<div class="kt-header__topbar-user">
				...
				<span class="kt-header__topbar-username kt-hidden-mobile"><?= $this->getRequest()->getAttribute('identity')['name'] ?></span>
				<img class="kt-hidden" alt="Pic" src="<?= $this->Url->assetUrl('/assets/media/users/300_25.jpg') ?>" />

				<!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
				<span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold"><?= strtoupper(substr($this->getRequest()->getAttribute('identity')['name'], 0, 1)) ?></span>
			</div>
		</div>
		<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">

			<!--begin: Head -->
			<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(<?= $this->Url->assetUrl('/assets/media/misc/bg-1.jpg') ?>)">
				<div class="kt-user-card__avatar">
					<img class="kt-hidden" alt="Pic" src="<?= $this->Url->assetUrl('/assets/media/users/300_25.jpg') ?>" />

					<!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
					<span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success"><?= strtoupper(substr($this->getRequest()->getAttribute('identity')['name'], 0, 1)) ?></span>
				</div>
				<div class="kt-user-card__name">
					<?= $this->getRequest()->getAttribute('identity')['name']; ?>
				</div>
			...
			<div class="kt-notification">
				...
				<div class="kt-notification__custom kt-space-between">
					...
					<?= $this->Html->link(
						'Sign Out',
						['prefix'=>'Admin','controller' => 'Users', 'action' => 'logout', '_full' => true],
