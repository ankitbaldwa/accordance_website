...
class ProductFeaturesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '0 for Inactive and 1 for Active', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-02-22 16:51:35',
                'modified' => '2021-02-22 16:51:35',
            ],
        ];
        parent::init();
    }
