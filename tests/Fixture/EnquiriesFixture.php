...
class EnquiriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mobile' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'package_id' => ['type' => 'index', 'columns' => ['package_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-02-22 16:30:27',
                'modified' => '2021-02-22 16:30:27',
            ],
        ];
        parent::init();
    }
